...
class Isobj:
    # This init method is to get parent, obj and list12.
    def __init__(self,parent,obj,list12):
        ...
        self.__playerx=0
        self.__playery=0
        person=PhotoImage(file="worker.png")
        box=PhotoImage(file="box.png")
        floor=PhotoImage(file="floor.png")
        wall=PhotoImage(file="wall.png")
        destination=PhotoImage(file="dock.png")
        box_on_destination=PhotoImage(file="box_docked.png")
        obj2=Sokoban()
    ...
    # This method is to get the list_obj.   
    def get_obj(self):
        return self.__list_obj()
    
    # This method works when you closed the game.
    def ok_cancel(self):
    ...
    # This method works when user press left arrow key on keyboard.
    ...
    # This method works when user press right arrow key on keyboard.
    ...
    # This method works when user press up arrow key on keyboard.
    ...
    # This method works when user press down arrow key on keyboard.
    ...
    # This method works after every completion of one level.
    def check(self):
    ...
    # This method works when you finished all levels or when you closed the game.
    def write(self):
